...
class TestGetProcessedDatasetMap(LoginTestCase):
    ...
    def create_datasets(self):
        # create datasets
        self.owned_bedfile = Dataset(id=1, user_id=1, filetype="bedfile", dataset_name="testfile")
        self.not_owned_bedfile = Dataset(id=2, user_id=2, filetype="bedfile", dataset_name="testfile2")
        self.owned_coolerfile = Dataset(id=3, user_id=1, filetype="cooler", dataset_name="testfile3")
        self.owned_datasets = [self.owned_bedfile, self.owned_coolerfile]
        # create intervals
        ...
        # create pileups
        self.pileups = [
            AverageIntervalData(id=1, binsize=1000, dataset_id=3, intervals_id=1 ,value_type="Obs/Exp"),
            AverageIntervalData(id=2, binsize=1000, dataset_id=3, intervals_id=1, value_type="ICCF"),
            AverageIntervalData(id=3, binsize=2000, dataset_id=3, intervals_id=2, value_type="Obs/Exp"),
            AverageIntervalData(id=4, binsize=2000, dataset_id=3, intervals_id=2, value_type="ICCF")
        ]
