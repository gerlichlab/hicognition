<template>
    <div class="half-width">
        <md-steppers :md-active-step.sync="active" md-linear>
            <md-step
                id="first"
                md-label="Upload Metadata file"
                :md-error="firstStepError"
                :md-editable="false"
                :md-done.sync="first"
            >
                <addMetadataForm
                    @success="handleMetadataAdditionSuccessful"
                    @form-error="handleMetadataAdditionError"
                ></addMetadataForm>
                <md-button
            ...
            <md-step
                id="second"
                md-label="Specify Metadata fields"
                :md-editable="false"
                :md-done.sync="second"
            >
                <addMetadataFieldsForm
                    :availableFields="fields"
                    :metadataID="metadataID"
                    @success="handleFieldAdditionSuccessful"
                ></addMetadataFieldsForm>
                <md-button
                    class="md-raised md-primary"
                    @click="$emit('close-dialog')"
