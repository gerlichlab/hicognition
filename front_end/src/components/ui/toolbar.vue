        ...
        <div class="md-toolbar-row span-window-horizontal">
            ...
            <div class="md-toolbar-section-end">
                <md-menu md-size="auto" md-align-trigger>
                    ...
                    <!-- <md-badge :style="badgeStyle" :md-content="numberNotifications" md-dense>
                    ...
                    <div class="md-badge-content">
                        <md-button class="md-icon-button" md-menu-trigger :disabled="numberNotifications == 0">
                        <md-icon>notifications</md-icon>
                        </md-button>
                        <div class="md-badge md-position-top md-dense md-theme-default" v-show="numberNotifications > 0">
                            {{this.numberNotifications}}
                        </div>
                    </div>

                    <md-menu-content>
                        <md-menu-item v-for="item in notifications" :key="item.id" @click="handleSetNotificatonRead(item.id)">
...
export default {
    ...
    mounted: function() {
        ...
        this.notificationSource.addEventListener("processing_finished", this.handleProcessingFinished)
    }
};
</script>
